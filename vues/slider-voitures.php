<!--<div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
  <div id="default-carousel" class="relative mb-4 mt-4 ml-4" data-carousel="static">
    Carousel wrapper 
    <div class="overflow-hidden relative h-fit rounded-lg sm:h-64 xl:h-80 2xl:h-96">
      -Item 1 
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <span class="absolute top-1/2 left-1/2 text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl dark:text-gray-800">First Slide</span>
            <?php echo "<img class=\"block absolute top-1/2 left-1/2 w-full object-fit -translate-x-1/2 -translate-y-1/2\" src=".$voiture['IMG']." alt=\"Voiture\">" ?>
        </div>
         Item 2 
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
...
<?php echo "<img class=\"h-auto max-w-lg object-center rounded-lg\" src=".$voiture['IMG']." alt=\"Voiture\">" ?>
</div>