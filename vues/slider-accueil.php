...
<div class="max-w-2xl mx-auto pt-15">
    <h1 class="text-center text-clifford text-3xl">Bienvenue sur le tout nouveau site du Garage V.Parrot de Toulouse</h1>
    <p class="text-gray-700 text-center text-2xl">Toute notre équipe de professionnels sera ravie de vous accueillir. 
        Si vous souhaitez des renseignements sur nos services, sur nos véhicules d'occasion ou prendre rendez-vous, n'hésitez pas à nous contacter !</p>
</div>